                    ...
                    <div id="metro_n_districts" class="mfp-hide white-popup-block distromet"  data-cat="buildings">
                        ...
                        <div class="districts-popup popsh" id="pop-sdistricts">
                            <div class="area_maps clearfix">
                                ...
                                ?>
                                <img id="mapdistr" data-src="/asset/assets/img/map-distr.jpg" alt="" usemap="#map">
                                <map name="map">
                                ...
                                <?php foreach($rayons as $value):?>
                                    <img data-src="/asset/assets/img/d<?php echo $value['id']; ?>.png" width="532" height="672" usemap="#map" class="area_region area_region_<?php echo $value['id']; ?>" style="display: <?php echo (in_array($value['id'], $rayon_array))?'block':'none'; ?>;">
                                <?php endforeach; ?>
                            </div>
