    ...
    <div class="">
            ...
            Хотите <span>продать</span> квартиру?
                ...
                <div class="relrow">
                    <div class="main_nav_block">
                        <div class="filter-result-sort">
                            ...
                            <select class="sortings-filt-date">
                                <option value="asc" <?php if ($this->session->userdata('sort_price_elite') == 'asc'){?>selected<?php } ?>>цена по возрастанию</option>
                                <option value="desc" <?php if ($this->session->userdata('sort_price_elite') == 'desc'){?>selected="selected"<?php } ?>>цена по убыванию</option>
                            </select>
                            ...
                            <div class="show_right_sort">
                                <a href="#" class="<?php if ($shown['plitter_elite'] == 'list'){?>chplit<?php } ?> plit plist" data-value="plit">Плитка</a>
                                <a href="#" class="<?php if ($shown['plitter_elite'] == 'plit'){?>chplit<?php } ?> lisst plist" data-value="list">Список</a>
                                <a href="#elite-map" class="onmap">На карте</a>
                            </div>
                        </div>
                        <?php if($empty): ?>
                    ...
                    <?php $this->load->view('themes/default/tmpl/fastsearch_elite'); ?>
                    <?php if ($shown['plitter_elite'] == 'plit'){?>
