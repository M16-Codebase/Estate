...
?>
<div class="mainhead block-novostoy-intro" style="background: url('/asset/uploads/images/slider/7fbf981ac363f73bd64fb0510959fa90.jpg') no-repeat top center">
	<div class="contain">
		<div class="mainfilter">
			<div class="filterchoose clearfix">
                ...
                $current = 'buildings';
                $tabs = array(
                    'buildings'		=> array('id' => 1, 'class' => 'buildtab',	'name' => 'Коммерческая')
                );
                ?>
                <ul class="tabs">
                    <?php foreach ($tabs as $key => $tab) { $active = ($key == $current)?' active':''; ?>
                        <li><a href="/commerce/active_tab/<?php echo $key ?>" class="tabcc <?php echo $tab['class'].$active; ?>" id="selcont-<?php echo $tab['id']; ?>"><?php echo $tab['name']; ?></a></li>
                    <?php } ?>
                </ul>
			</div>
			<div class="filtercont">
				<div class="filter-display active" id="cont-1">
					...
					<form method="get" class="buildings-form" action="/commerce">
