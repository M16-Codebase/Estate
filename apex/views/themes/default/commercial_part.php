    ...
    <div class="">
            ...
            Хотите <span>продать</span> квартиру?
                ...
                <div class="relrow">
                    <div class="main_nav_block">
                        <div class="filter-result-sort">
                            ...
                            <select class="sortings-filt-date">
                                <option value="asc" <?php if ($this->session->userdata('sort_price_commercial') == 'asc'){?>selected<?php } ?>>цена по возрастанию</option>
                                <option value="desc" <?php if ($this->session->userdata('sort_price_commercial') == 'desc'){?>selected="selected"<?php } ?>>цена по убыванию</option>
                            </select>
                            ...
                            <div class="show_right_sort">
                                <a href="#" class="<?php if ($shown['plitter_commercial'] == 'list'){?>chplit<?php } ?> plit plist" data-value="plit">Плитка</a>
                                <a href="#" class="<?php if ($shown['plitter_commercial'] == 'plit'){?>chplit<?php } ?> lisst plist" data-value="list">Список</a>
                                <a href="#comlink" class="onmap">На карте</a>
                            </div>
                        </div>
                        <?php if($empty): ?>
                            <p class="notfnd">По вашему запросу ничего не найдено</p>
                        <?php endif; ?>
                        <div class="filter-result-paging headpag sm_selectpage" data-category="SelectPage" data-label="buildings">
                    ...
                    <?php $this->load->view('themes/default/tmpl/fastsearch_commercial'); ?>
                    <?php if ($shown['plitter_commercial'] == 'plit'){?>
                                        ...
                                        <div class="onecol mcol-4<?php if($k == 4):?> nomargin<?php endif;?>">
                                            <a href="<?=$r->link?>" class="object-item sm_search" data-category="SelectObject" data-label="buildings">
                                                ...
                                                <div class="filter-result-item-body">
                                                    ...
                                                    <?php if(isset($r->sdelka)):?><p class="filter-result-item-size"><?=$r->sdelka?></p><?php endif;?>
                                                    <div class="addbott">
                                                        <div class="filter-result-item-address"><?=$r->adress?>
                                                            <?php if(!empty($r->metro)):?><span class="filter-result-item-metro"><span><?=$r->metro?></span></span><?php endif; ?>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <?php foreach($rows as $r): ?>
                                ...
                                <div class="filter-result-row clearfix">
                                    ...
                                    <a href="<?php echo $r->link; ?>" class="filter-result-item-plit sm_search" data-category="SelectObject" data-label="buildings">
                                        ...
                                        <div class="filter-result-item-body">
                                            <div class="priceres"><?=$r->price?></div>
                                            <p class="filter-result-item-size"><?php echo $r->sdelka; ?></p>
                                            <div class="infoit">
