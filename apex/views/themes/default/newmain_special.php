<section id="spcd" class="container-fluid fil-result-nov main-content main-content-top"
         style="background: transparent;"> <!--спецпредложения-->
    <div class="container">
        <div class="wrapTextCenter"><h2>Новинки</h2><a href="/buildings" class="blocks-in"
                    ...
                    <div class="mrow clearfix"><?php foreach ($data as $key => $value) {
                            ...
                            <div class="onecol mcol-4<?php echo ($key == 3) ? ' nomargin' : ''; ?>"><a
                                ...
                                <div class="img_fil"><img class="filter-result-item-img"
                                                          ...
                                                          alt="<?= $value['name'] ?>"><span
                                            class="signcat <?= $value['sign']['class'] ?>"><?= $value['sign']['name'] ?></span>
                                ...
                                <div class="filter-result-item-body"><p
                                            class="filter-result-item-rayon"><?= $value['rayon'] ?></p>
                                    <p class="filter-result-item-name"><?= $value['name'] ?></p><?php if (isset($value['deadline'])): ?>
                                        <p class="filter-result-item-size"><?= $value['deadline'] ?></p><?php endif; ?>
                                    <div class="addbott">
                                        <div class="filter-result-item-address"><?= $value['address'] ?> <?php if (!empty($value['metro'])): ?>
                                            <span class="filter-result-item-metro"><span><?= $value['metro'] ?></span><?php endif; ?></span>
                                        </div>
                                    </div>
                                </div>
