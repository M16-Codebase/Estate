...
$author = $author[0];
$art_ids=$author['articles_id_cache'];
$ids=explode(',',$art_ids);
$data_art=array();
foreach ($ids as $key=>$id){
    $datum=$this->load->module('news')->getArticle($id);
    $data_art[$key]['title']=$datum[0]['name'];
    $data_art[$key]['shorting']=$datum[0]['shorting'];
    $data_art[$key]['image']=$datum[0]['mainfoto'];
    $data_art[$key]['link']=$datum[0]['link'];
}
?>
<style>
    .author-head {
