                ...
                <div class="relrow">
                    <div class="filter-result-sort">
                        <select class="sortings-filt-date">
                            <option value="asc" <?php if ($this->session->userdata('sort_price_land') == 'asc'){?>selected<?php } ?>>цена по возрастанию</option>
                            <option value="desc" <?php if ($this->session->userdata('sort_price_land') == 'desc'){?>selected="selected"<?php } ?>>цена по убыванию</option>
                        </select>
                        ...
                        <div class="show_right_sort">
                            <a href="#" class="<?php if ($this->session->userdata('plitter_land') == 'list'){?>chplit<?php } ?> plit plist" data-value="plit">Плитка</a>
                            <a href="#" class="<?php if ($this->session->userdata('plitter_land') == 'plit'){?>chplit<?php } ?> lisst plist" data-value="list">Список</a>
                            <a href="#lands-map" class="onmap">На карте</a>
                        </div>
                    </div>
                    <?php if($empty): ?>
                    ...
                    <?php if ($this->session->userdata('plitter_land') == 'plit'){?>
                                    ...
                                    <div class="onecol mcol-4<?php if($k == 4):?> nomargin<?php endif;?>">
                                        <a href="<?=$r->link?>" class="object-item sm_search" data-category="SelectObject" data-label="buildings">
                                            ...
                                            <div class="filter-result-item-body">
                                                ...
                                                <p class="filter-result-item-size"><?=$r->tokad?></p>
                                                <div class="addbott">
                                    ...
                                    <a href="<?php echo $r->link; ?>" class="filter-result-item-plit sm_search" data-category="SelectObject" data-label="buildings">
                                        ...
                                        <div class="filter-result-item-body">
                                            ...
                                            <div class="infoit">
                                                ...
                                                <?php endif; ?>
                                                <?php if(!empty($r->tokad)):?>
                                                    <div class="initem"><label>Расстояние до КАД</label><p class="filter-result-item-address"><?php echo $r->tokad; ?></p></div>
                                                <?php endif; ?>
                                            </div>
