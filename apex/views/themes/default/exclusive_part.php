    ...
    <div class="">
            ...
            Хотите <span>продать</span> квартиру?
                ...
                <div class="relrow">
                    <div class="main_nav_block">
                        <div class="filter-result-sort">
                            ...
                            <select class="sortings-filt-date">
                                <option value="asc" <?php if ($this->session->userdata('sort_price_exclusive') == 'asc'){?>selected<?php } ?>>цена по возрастанию</option>
                                <option value="desc" <?php if ($this->session->userdata('sort_price_exclusive') == 'desc'){?>selected="selected"<?php } ?>>цена по убыванию</option>
                            </select>
                            ...
                            <div class="show_right_sort">
                                <a href="#" class="<?php if ($shown['plitter_exclusive'] == 'list'){?>chplit<?php } ?> plit plist" data-value="plit">Плитка</a>
                                <a href="#" class="<?php if ($shown['plitter_exclusive'] == 'plit'){?>chplit<?php } ?> lisst plist" data-value="list">Список</a>
                                <a href="#exlink" class="onmap">На карте</a>
                            </div>
                        </div>
                        <?php if($empty): ?>
                    ...
                    <?php $this->load->view('themes/default/tmpl/fastsearch_exclusive'); ?>
                    <?php if ($shown['plitter_exclusive'] == 'plit'){?>
