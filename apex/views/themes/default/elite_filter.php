...
$inmetro = $this->metro_model->getAllFilter(3);

$this->load->model('rayon/rayon_model','rayon_model');
$rayons = $this->rayon_model->getAllFilter(3);
    ...
    <div class="contain">
        <div class="mainfilter">
            <div class="filterchoose clearfix">
                <?php echo $this->load->view(getPath(__FILE__,'/parth_filter_menu'), array('current' => 'elite'), TRUE); ?>
            </div>
            <div class="filtercont">
                <div class="filter-display active" id="cont-1">

                    <form method="get" class="elite-form" action="/elite">
                            ...
                            <div class="short-filter clearfix">
                                <div class="scolumn fcolumn">
                                    <div class="clearfix one-filter-price">
                                        ...
                                        <div class="filter-slider-container">
                                            <div id="price-slider-elite" class="filter-slider range"></div>
                                        </div>
                                        <div class="prdiv price-b" data-min="<?php echo $filter->minMax['min']; ?>" data-max="<?php echo $filter->minMax['max']; ?>">
                                            <span class="sq_uch">от </span>
                                            <input type="text" name="price_from" id="ePrice-from" class="price_input" value="<?php echo $params['price_from']; ?>" />
                                            <span class="sq_uch"> до </span>
                                            <input type="text" name="price_to" id="ePrice-to" class="price_input" value="<?php echo $params['price_to']; ?>" />
                                        </div>
                                    </div>
                                ...
                                <div class="lcolumn fcolumn">
                                    <div class="clearfix one-filter-price">
                                        ...
                                        <div class="filter-slider-container">
                                            <div id="square-slider-elite" class="filter-slider range"></div>
                                        </div>
                                        <div class="prdiv square-b" data-min="<?php echo $filter->minMaxS['min']; ?>" data-max="<?php echo $filter->minMaxS['max']; ?>">
                                            <span class="sq_uch">от </span>
                                            <input type="text" name="square_from" id="eSquare-from" class="price_input" value="<?php echo $params['square_from']; ?>" />
                                            <span class="sq_uch"> до </span>
                                            <input type="text" name="square_to" id="eSquare-to" class="price_input" value="<?php echo $params['square_to']; ?>" />
                                        </div>
                                    </div>


                                    <div class="clearfix one-filter long-filter mtop37">
                                        <input type="text" placeholder="Введите адрес" name="adress" value="<?php echo $params['adress'];?>" class="filter-input elite_txt" id="aadrr" data-name="elite">
                                    </div>
                                </div>
                                <div class="lcolumn fcolumn">
                                    ...
                                    <div class="clearfix one-filter">
                                        ...
                                        <div class="btn-group chk-btn" data-toggle="buttons">
                                            ...
                                            <label class="btn btn-primary<?php if(in_array(2, $room_array)) echo ' active'; ?>">
                                                <input type="checkbox" value="2" <?php if(in_array(2, $room_array)) echo 'checked'; ?> class="elite-check">1
                                            </label>

                                            <label class="btn btn-primary<?php if(in_array(3, $room_array)) echo ' active'; ?>">
                                                <input type="checkbox" value="3,16" <?php if(in_array(3, $room_array)) echo 'checked'; ?> class="elite-check">2
                                            </label>
                                            <label class="btn btn-primary<?php if(in_array(4, $room_array)) echo ' active'; ?>">
                                                <input type="checkbox" value="4,17" class="elite-check" <?php if(in_array(4, $room_array)) echo 'checked'; ?>>3
                                            </label>
                                            <label class="btn btn-primary<?php if(in_array(5, $room_array)) echo ' active'; ?>">
                                                <input type="checkbox" value="5,18" class="elite-check" <?php if(in_array(5, $room_array)) echo 'checked'; ?>>4
                                            </label>
                                            <label class="btn btn-primary<?php if(in_array(6, $room_array)) echo ' active'; ?>">
                                                <input type="checkbox" class="elite-check" value="6,7,32,31,21" <?php if(in_array(6, $room_array)) echo 'checked'; ?>>5+
                                            </label>
                                        </div>
                                    </div>
                                    <div class="clearfix one-filter long-filter">
                                        <input type="hidden" name="country" value="0" class="sel_abroad_country" />
                                        <input type="text" id="ecity" placeholder="ЖК" name="name" value="<?=$params['name']?>" class="filter-input filter-input-large elite_txt">
                                    </div>
                                </div>
                            </div>
<!--noindex-->
...
<!--noindex-->
                    <div id="metro_n_districts" class="mfp-hide white-popup-block distromet" data-cat="elite">
