                        ...
                        <div class="fixed-container clearfix">
                            ...
                            <div class="block-right text-center">
                                ...
                                <?php if(!empty($in_favorites)):?>
                                    <a href="#" class="addtofavorite" data-category="resale" data-id="<?php echo $id; ?>" data-action="delete">Убрать из избранного</a>
                                <?php else: ?>
                                    <a href="#" class="addtofavorite notinf" data-category="resale" data-id="<?php echo $id; ?>" data-action="add">В избранное</a>
                                <?php endif;?>
                            </div>
                        </div>
                    </div>
    ...
    <div class="fixed-container clearfix">
        ...
        <div class="complex-info-col-right">
            <div class="active infobl descrip">
                ...
                <div class="complex-text"><?php echo $rows->text; ?><?php if ($id == 428):?><a class="fancyframe" data-fancybox-type="iframe" href="http://m16-estate.ru/asset/uploads/3d/pesochnaya12/pesochnaya12.html">This goes to iframe</a><?php endif; ?></div>
                ...
                <div class="uric-block" style="margin-top: 50px">
                    ...
                    <form id="uric-form" style="text-align: left; padding: 10px; border: 1px solid #cbcbcb;" onsubmit="yaCounter29760432.reachGoal('LAW_SAFETY_CONVOY'); ga('send', 'event', 'lp_vtorichka', 'LAW_SAFETY_CONVOY'); return sendForm(this);">
...
<div id="askLand" class="mfp-hide white-popup-block askpopup" data-name="Городская недвижимость | <?=$rows->header;?>" data-link="<?=getUrl();?>">
    <p class="ask_caption">Ответим на ваш вопрос, в течение ближайших 5 минут, либо в любое удобное для вас время</p>
    <form id="land_form_ask" data-catalog="resale">
        <div class="rowd">
        ...
        <div class="rowd">
            <input type="submit" class="submit-ask" name="submit" value="отправить" onclick="yaCounter29760432.reachGoal('otpravit-vse-zayav'); _gaq.push(['_trackEvent', 'OtpravitVoprosGorod', 'Click']); return true;" />
        </div>
    </form>
</div>
