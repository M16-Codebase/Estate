 ...
 *
 * $Id: MCAPI.php 4302 2010-07-21 00:00:00 garryw $
 *
 * @package    MCAPI
 * @author     Garry Welding
 */
 
class Mcapi extends MX_Controller {
    ...
    {
		$this->load->config('admin/mcapi');
		
        $this->secure = $this->config->item('mcapi_secure');
        $this->apiUrl = parse_url("http://api.mailchimp.com/" . $this->version . "/?output=php");
        $this->api_key = $this->config->item('mcapi_apikey');
		
		//unset($this->CI);
    
    	log_message('debug', "MCAPI Class Initialized");
     ...
     * Запланированную кампанию, которая запланирована для передачи в будущем
     * 
     ...
     * График кампании будут направлены в будущее
     *
     * @section Campaign  Related
     ...
     * Возобновить отправку автоответчика или RSS кампании
     *
     * @section Campaign  Related
     *
     ...
     * Пауза кампании AutoResponder orRSS от отправки
     *
     * @section Campaign  Related
     *
     * @param string $cid the id of the campaign to pause
     ...
     * Отправить данную кампанию немедленно. Для кампаний RSS, это будет "начало" их.
     *
     * @section Campaign  Related
     *
     ...
     * Отправить тест этой кампании по указанному электронному адресу
     *
     * @section Campaign  Related
     *
     ...
     * Получить все шаблоны, определенные для учетной записи пользователя
     *
     * @section Campaign  Related
     ...
     * Позволяет проверить свои правила сегментации, прежде чем создавать кампанию, используя их
     *
     * @section Campaign  Related
     ...
     * Создайте новую кампанию черновик, чтобы отправить. Вы не можете <strong> </ STRONG> есть более чем 32 000 кампаний в своем аккаунте.
     *
     * @section Campaign  Related
    ...
    * @param array $type_opts optional - 
     ...
     * Обновите почти любой настройки для кампании, которая <em> не </ EM> было отправлено. См. campaignCreate () для деталей.
     *   
     *  
     *  Caveats:<br/><ul>
    ...
    * Удалить кампании. Серьезно, "пуф, нет!" - Будьте внимательны!
    * 
    * @section Campaign  Related
    *
    ...
    */
     ...
     * Получить список кампаний и их детали, соответствующие указанному фильтры
     *
     * @section Campaign  Related
     ...
     * Перечислить все папки для учетной записи пользователя
     *
     * @section Campaign  Related
     ...
     * @returnf integer folder_id Folder Id for the given folder, this can be used in the campaigns() public function to filter on.
     ...
     * Учитывая список и кампании, получить все соответствующие статистические данные кампании (открыто, отказы, клики и т.д.)
     *
     ...
     * Получить все адреса электронной почты для отписаться данной кампании
     *
     * @section Campaign  Stats
     *
     * @param string $cid the campaign id to pull bounces for (can be gathered using campaigns())
     ...
     * Получить все адреса электронной почты, которые жаловались на данную кампанию
     *
     * @section Campaign  Stats
     *
     ...
     * Получить странах и число отслеживаемых открывается для каждого. Адрес электронной почты не возвращаются.
     * 
     * @section Campaign  Stats
     *
     *
     ...
     * 
     * Получить полный рикошеты для данной кампании. Заметим, что это может вернуться очень больших количествах
     * Данных в зависимости от размера кампании было и сколько хлама отказов возвратил. Кроме того,
     * Сообщение через 30 дней могут оставаться удалены
     * 
     * @section Campaign  Stats
     *
     ...
     * Получить содержание (как HTML и текст) для кампании или как она будет выглядеть в кампании архиве или в качестве исходного, оригинального контента
     *
     * @section Campaign  Related
     *
    ...
    /**
     * Retrieve the list of email addresses that opened a given campaign with how many times they opened - note: this AIM public function is free and does
     ...
     * Получить список адресов электронной почты, которые не открыть данную кампанию
     *
     * @section Campaign AIM
     *
     ...
     * Возвращает список адресов электронной почты, нажал на данной ссылке, и сколько раз они нажали
     *
     * @section Campaign AIM
     *
     ...
     * Учитывая кампанию и адрес электронной почты, вернуть весь мыши и откройте историю с временными метками, упорядоченные по времени
     *
     * @section Campaign AIM
     *
     ...
     * Получить все списки определены для учетной записи пользователя
     *
     ...
     * Получить список бирок для данного списка, в том числе их название, теги, и требуемое значение
     *
     * @section List Related
     ...
     * Добавить новый тег слияния для данного списка
     *
     * @section List Related
     ...
     * Обновите большинство параметров для тега слияния на данном списке. В настоящее время нельзя изменить тип слияния
     *
     * @section List Related
     *
     * @param string $id the list id to connect to. Get by calling lists()
     ...
     * <strong> DEPRECATED: </ STRONG> Получить список групп интересов для данного списка, в том числе этикетки и формы информации
     *
     ...
     * Получить список групп интересов для данного списка, в том числе этикетки, форму информации, а также включены группы для каждого
     *
     * @section List Related
     ...
     * Вернуться Webhooks настроен для заданного списка
     *
     * @section List Related
     * 
     * @param string $id the list id to connect to. Get by calling lists()
     ...
     * Получить все статические Сегменты для списка.
     *
     * @section List Related
     * 
     * @param string $id the list id to connect to. Get by calling lists()
     ...
     * Подписаться по указанному вами адресу в список. По умолчанию это посылает подтверждение по электронной почте - вы не увидите новых членов до ссылки, содержащиеся в нем не будет нажата!
     *
     * @section List Related
     *
     ...
     * Отказаться от данного адреса электронной почты из списка
     *
     * @section List Related
     ...
     * 
     * Измените адрес электронной почты, поля слияния, и заинтересованные группы для списка пользователя. Если вы делаете пакетного обновления на большое количество пользователей,
     * Рассмотреть возможность использования listBatchSubscribe () с update_existing и возможных параметров replace_interests.
     *
     * @section List Related
     ...
     * Получить все члены списка для списка, которые имеют особый статус
     *
     * @section List Related
     ...
     * Получить всю информацию для конкретного члена списка
     *
     * @section List Related
     ...
     * Доступ Рост История по месяцам для данного списка.
     *
     * @section List Related
     *
     ...
     * 
     * Получить много учетной записи, включая платежи, план информации, некоторые счета статистики, установленные модули,
     * Контактные данные и многое другое. Ни одна частная информация, как номера кредитных карт отсутствует.
     * 
     * @section Helper
     *
     ...
     * У HTML содержание авто-преобразуется в текстовом формате. Вы можете отправить: простой HTML, массив шаблонов содержания, существующий идентификатор кампании или существующий идентификатор шаблона. Заметим, что это не <b> </ B> сохранять ничего или обновить любой из ваших списков, кампаний или шаблонов.
     *
     * @section Helper
     ...
     * Отправьте HTML содержанием иметь встроенный CSS и, возможно, удалить оригинальных стилей.
     *
     * @section Helper
     ...
     * Получить все Список IDS членом подписан.
     *
     * @section Helper
     * 
     * @param string $email_address the email address to unsubscribe  OR the email "id" returned from listMemberInfo, Webhooks, and Campaigns
     ...
     * Возвращает текущий сообщений чата шимпанзе для учетной записи.
     *
     * @section Helper
     * 
     ...
     * Получить список всех ключей MailChimp API для этого пользователя
     *
     ...
     * Добавить ключ API на ваш счет. Мы будем генерировать новый ключ для вас и вернуть его.
     *
     * @section Security Related
     * @example xml-rpc_apikeyAdd.php
     *
    ...
    /**
     * Internal public function - proxy method for certain XML-RPC calls | DO NOT CALL
     ...
     * 
     * На самом деле подключиться к серверу и просил называть методы, анализ результатов
     * Вы никогда не должны должны вызывать эту функцию вручную общественности
     */
     ...
     * Повторно реализовать http_build_query для систем, которые его еще нет
     */
