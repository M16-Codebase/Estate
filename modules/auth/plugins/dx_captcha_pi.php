...
function create_captcha($data = '', $img_path = '', $img_url = '', $font_path = '')
{
	...
	$defaults = array('word' => '', 'img_path' => '', 'img_url' => '', 'img_width' => '115', 'img_height' => '32', 'font_size' => '', 'font_path' => '', 'show_grid' => true, 'skew' => true, 'expiration' => 7200);
   ...
   if ($word == '')
   {
	...
	return array('word' => $word, 'time' => $now, 'image' => $img, 'images' => $img_url.$img_name);
}
