...
// админу не к чему видеть запись суперадмина
if(!is_super()) 
{ 
    if(uri(3) == 'roles')
    {
...
<div class="panel-control align-right white-gradient">
    ...
    <div class="float-left">
        <div  class="button-group">
            <a href="<?php echo BASEURL; ?>/admin/list_fields/<?php echo $moduleName; ?>_users" class="button gray-gradient glossy">Поля общие</a>
            <a href="<?php echo BASEURL; ?>/admin/list_fields/auth_user_profile" class="button gray-gradient glossy">Поля профиля</a>
