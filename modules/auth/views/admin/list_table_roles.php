...
<div class="panel-control align-right white-gradient">
    ...
    <div id="load_button_action" class="float-right">                       
       <div  class="button-group align-right">                                                    
           <a href="<?php echo BASEURL; ?>/<?php echo $moduleName; ?>/admin/roles/add" class="button icon-plus-round white-gradient sets_add glossy"> <?php echo $alang->admin_add; ?></a>                                              
           ...
           <a href="javascript:void(0);" class="button icon-gear white-gradient sets_setting glossy with-tooltip hidden" title="Выбор настроки"></a>                           
       </div>
    </div>
    ...
    <div class="float-left">
        <div  class="button-group">
            <a href="<?php echo BASEURL; ?>/admin/list_fields/auth_roles" class="button gray-gradient glossy">Поля</a>
...
<div class="with-padding scrollable">
                ...
                <tr class="dlt<?php echo $key; ?>">
        			...
        			<td class="align-right">
                        <div class="button-group compact children-tooltip" data-tooltip-options='{"position":"right"}'>
                            <a href="<?php echo BASEURL; ?>/<?php echo $moduleName; ?>/admin/roles/edit/<?php echo $key; ?>" class="button icon-pencil" title="<?php echo $alang->admin_edit; ?>"></a>
    ...
    <div class="table-footer button-height large-margin-bottom hidden">
...
<div class="hidden">
    ...
    <span id="urlData"><?php echo BASEURL; ?>/auth/admin/roles/deleteRow</span>
