...
<div class="hidden">
    <span id="urlData"><?php echo BASEURL; ?>/commerce/admin/index/delete</span>
    <span id="uriData"><?php echo BASEURL; ?>/commerce/admin/index</span>
    <span id="moduleName" data-module="commerce" data-table="commerce"></span>
</div>