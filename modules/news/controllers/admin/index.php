    ...
    **/
    ...
    {        
        ...
        if($this->input->post('dani'))
        {
            ...
            $date = explode('.', $mas['date']);
            $mas['date'] = $date[2].'-'.$date[1].'-'.$date[0];
    ...
    **/
    ...
    {        
        ...
        {                        
            ...
            $mas['ncategory'] = explode(',', $mas['ncategory']);
    ...
    **/
    function parseJson($data)
    {
        if(is_array($data))
        {
            ...
            //if(!empty($sds['date'])) { $sds['date'] = strtotime($sds['date']); }
			...
			if(!empty($ncategory)) {
                $sds['ncategory'] = implode(',', $ncategory);
			}
        }
        else
        {
...
/** --------------------------------------------------------------------------------------------- **/
    ...
    **/
    ...
    {    
        ...
        $this->load->model('ncategory/admin_ncategory_model', 'admin_ncategory_model');
        $parent = $this->admin_ncategory_model->parent_id();
        foreach($parent as $p)
        {
