...
class admin_files_table_model extends CI_Model
{
	// конструктор
...
/** ************************************************************************************************************************************ **/
	...
	**/
    ...
    public function module_get_in($ids)
    {
	...
	**/
    ...
    public function module_edit_in($ids, $mas)
    {
        $this->db->where_in('id', $ids);
        return $this->db->update($this->table, $mas);
    }
