...
/** --------------------------------------------------------------------------------------------- **/
    ...
    **/
    ...
    {    
        ...
        $this->load->model('slider_category/admin_slider_category_model','admin_slider_category_model');
        $categor = $this->admin_slider_category_model->parent_id();
        $category = array();
        $category['0'] = ' -- не выбрано -- ';
        foreach($categor as $p)
        {
