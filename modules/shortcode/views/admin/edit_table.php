            ...
            <div id="<?php echo $tab1[0]['id']; ?>" class="with-padding"> <!-- ** Tab1 ** -->                                
                ...
                <div class="columns">                                
                    ...
                    <div class="three-columns new-row-mobile new-row-tablet twelve-columns-mobile twelve-columns-tablet"> 
                        <?php echo $iform->init('name'); ?>                        
                    </div> 
                    
                     <div class="four-columns new-row-mobile new-row-tablet twelve-columns-mobile twelve-columns-tablet"> 
                        <?php echo $iform->init('title'); ?>                        
                    </div>
                                                            
                    <div class="two-columns new-row-mobile new-row-tablet twelve-columns-mobile twelve-columns-tablet"> 
                        <?php echo $iform->init('sort'); ?>                        
                    </div>
                    ...
                    <div class="twelve-columns new-row-mobile new-row-tablet twelve-columns-mobile twelve-columns-tablet"> 
                        <?php echo $iform->init(array('text','text_en')); ?>                        
                    </div>
