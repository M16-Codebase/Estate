...
class admin_rayon_model extends CI_Model
{
	// конструктор
    ...
    **/
    ...
    {                     
        ...
        {            
            $sql = "
                    CREATE TABLE `ci_rayon` (
                    	`id` INT(10) NOT NULL AUTO_INCREMENT,
                    	`name` VARCHAR(50) NULL DEFAULT NULL,
                        `sort` INT(3) NULL DEFAULT '10',
	                    `banned` INT(2) NULL DEFAULT '0',
                    	PRIMARY KEY (`id`)
                    )
                    COMMENT='Районы'
...
/** ********************************************************************************************************************************** **/    
	...
	**/
    public function parent_id($id = NULL, $id_sort=NULL ,$sort = NULL)
    {
