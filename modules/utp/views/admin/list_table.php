...
<div class="panel-control align-right white-gradient">
    ...
    <div id="load_button_action" class="float-right">                       
       <div  class="button-group align-right">                                         
           ...
           <a href="javascript:void(0);" class="button anthracite-gradient" style="display: none;">Excel</a>
...
<div class="with-padding scrollable">
    ...
    <?php if(!empty($information)): ?>
        <p class="margin-bottom silver-gradient wrapped big-left-icon icon-info-round margin-bottom margin-right"><?php echo $information; ?></p>
    <?php endif; ?>    
