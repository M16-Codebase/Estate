...
<div class="panel-control align-right white-gradient">
    ...
    <div id="load_button_action" class="float-right">                       
       <div  class="button-group align-right">                                                    
           ...
           <a href="javascript:void(0);" class="button icon-gear white-gradient sets_setting glossy with-tooltip hidden" title="<?php echo $alang->admin_42; ?>"></a>
    ...
    <div class="float-left">
        <div  class="button-group">
            ...
            <a href="javascript:void(0);" onclick="loadDataContainer('<?php echo BASEURL; ?>/<?php echo $moduleName; ?>/admin/index/updateConfig', '#ajaxNotification'); $('#loadSettings').empty();" class="button gray-gradient glossy hidden">Обновить настройки</a>
        </div>
    </div>
    <?php endif; ?>
...
<div class="with-padding scrollable">
    ...
    <div class="table-footer button-height large-margin-bottom">
        ...
        <a href="/<?php echo uri(1); ?>/admin/index/index/all" class="button float-right">Посмотреть все</a>
    </div>	            
