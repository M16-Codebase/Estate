        ...
        <div class="tabs-content"> <!-- ** -------------------------- Tabs content ----------------------------- ** -->                		                        
            ...
            <div id="<?php echo $tab1[0]['id']; ?>" class="with-padding"> <!-- ** Tab1 ** -->                                                
                <div class="columns">                                    
                    ...
                    <div class="six-columns new-row-mobile new-row-tablet twelve-columns-mobile six-columns-tablet">
                        <?php echo $iform->init(array('name', 'email'), ''); ?>
                    </div>

                    <div class="six-columns new-row-mobile new-row-tablet twelve-columns-mobile six-columns-tablet">
                        <?php echo $iform->init(array('avatar', 'banned'), ''); ?>
                    </div>
