<style>#card_map { height: 400px !important; width: 100%; text-align: center; margin: 0 auto; }
            ...
            <div id="<?php echo $tab1[0]['id']; ?>" class="with-padding"> <!-- ** Tab1 ** -->                                                
                <div class="columns">                                    
                    ...
                    <div class="six-columns new-row-mobile new-row-tablet twelve-columns-mobile twelve-columns-tablet"> 
                        <?php echo $iform->init(array('name','link','country_id','city_id','address', 'price', 'currency_id', 'estate_type','house_type','rooms_id','floors','year','resale','sdelka_type','square_all','square_land','banned', 'interest', 'special'), 'Общая информация'); ?>
                    </div>
                                                                                                    
                    <div class="six-columns new-row-mobile new-row-tablet twelve-columns-mobile twelve-columns-tablet"> 
                        <?php echo $iform->init(array('title','keywords','description', 'consultant_id'), 'SEO блок'); ?>
                    </div>
                    <div class="six-columns new-row-mobile new-row-tablet twelve-columns-mobile twelve-columns-tablet">
                        <?php echo $iform->init(array('map'), 'Координаты'); ?>
                        <details class="details margin-bottom" open="">
                            <summary class="blue">Карта</summary>
                            <div class="with-padding columns">

                                <div id="templ_map" class="block-label mid-margin-bottom  button-height twelve-columns">
                                    <label for="map" class="label mid-margin-top">
                                        <span>
                                             <strong>Введите адрес</strong>
                                        </span>
                                        <small class="" id="small-map"></small>
                                    </label>
                                    <input type="text" value="" id="searchTextField" class="input full-width">
                                </div>
                                <div id="card_map"></div>
                    ...
                    <div class="twelve-columns"> 
                        <?php echo $iform->init(array('location','planirovka', 'infrastructure', 'vid','xml_text'), 'Текстовый блок'); ?>
                    </div>
                ...
                $("#card_map").gmap3({
                    get: {
                        ...
                        callback: function(marker){
                            ...
                            var value = marker.getPosition().lat() + '|' + marker.getPosition().lng();
                            $('#map').val(value);
                            $('#searchTextField').addClass("input full-width");
                        }
                    }
                });
                $("#card_map").gmap3({
