...
class admin_abroad_model extends CI_Model
{
	// конструктор
    ...
    **/ 
    ...
    public function addToSpecials($array){
        ...
        $data = array(
            ...
            'rayon'=>0,
            'line_top' => $parentcountry_list[$array['country_id']],
            'line_middle' => $parenthouse_list[$array['estate_type']],
            'currency' => $currencies[$array['currency_id']]
        );
        return $data;
    }
