        ...
        <div class="tabs-content"> <!-- ** -------------------------- Tabs content ----------------------------- ** -->
            ...
            <div id="<?php echo $tab1[0]['id']; ?>" class="with-padding"> <!-- ** Tab1 ** -->
                <div class="columns">
                    ...
                    <div class="six-columns new-row-mobile new-row-tablet twelve-columns-mobile twelve-columns-tablet">
                        <?php echo $iform->init(array('h1', 'title','keywords','description','banned','sort', 'consultant_id'), 'SEO блок'); ?>
                    </div>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBpY-3bznL5ZkxbzjONYIgWSuiIQhocYXQ"></script>
