...
class special extends MY_Controller {     
	...
	function index($offset = 0)
	{
        ...
        $dataRow = $this->$model->pagination($offset);
        ...
        $this->addVar('template', $this->render('special', $data)); // формируем шаблон
    ...
    function getRandom(){
        $model = $this->table.'_model';
        $this->load->model($this->module.'/'.$model, $model);
        $count = $this->$model->getSpecialsCount();
        $diff = $count/8;
        $rnd = floor($diff);
	...
	**/
    ...
    function showHide()
    {
        $model = $this->table.'_model';
        $this->load->model($this->module.'/'.$model, $model);
        $dataRow = $this->$model->getSpecialsHide();
        ...
        $this->load->view('themes/'.$this->defaultTheme.'/tmpl/'.'specials', $data);
    }
    ...
    function showObject($id = false)
    {
        ...
        $model = $this->table.'_model';
        $this->load->model($this->module.'/'.$model, $model);
        $dataRow = $this->$model->getSpecialsHide($id);
    ...
    function showMain()
    {
        ...
        $dataRow = $this->$model->getSpecials($off);
        ...
        $this->load->view('themes/'.$this->defaultTheme.'/'.'main_special', $data);
    ...
    function showNewMain()
    {
        ...
        $dataRow = $this->$model->getNewSpecials($off);
        ...
        foreach ($dataRow as $k => $v){
            ...
            //    $row['deadline'] = $this->dataKv($v['deadline']);
            //}
            $row['deadline'] = $this->dataKv($v['korpus_value']);
        ...
        $this->load->view('themes/'.$this->defaultTheme.'/'.'newmain_special', $data);
    ...
    */
	...
	function showArti()
    {
        ...
        $this->load->view('themes/'.$this->defaultTheme.'/'.'arti_special', $data);
