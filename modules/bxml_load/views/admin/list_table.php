...
<div class="panel-control align-right white-gradient">
    ...
    <div class="float-left">
        <div  class="button-group">
            ...
            <a href="javascript:void(0);" onclick="loadDataContainer('<?php echo BASEURL; ?>/<?php echo $moduleName; ?>/admin/index/updatePrices', '#ajaxNotification'); $('#loadSettings').empty();" class="button gray-gradient glossy">Обновить цены</a>
        </div>
    </div>
