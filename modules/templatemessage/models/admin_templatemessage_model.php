...
class admin_templatemessage_model extends CI_Model
{
	// конструктор
	public function __construct()
	{
        ...
        $this->fields = array( // создаем стандартный массив полей
            ...
            'send' => // видимость | 0 - показывать, 1 - скрывать
                array(
                         'type' => 'INT',
                         'constraint' => '1',
                         'null' => true,
                         'default' => '0',
                         'comment' => 'Кому отправлять письмо',
                         'comment_en' => '',
                         'newType' => 'enum'
                     ),
            'text' =>  
                array(
                         'type' => 'TEXT',
                         'null' => true,
                         'comment' => 'Текст письма который приходит пользователю',
                         'comment_en' => '',
                         'newType' => ''
                     ),
            'textadmin' =>  
                array(
                         'type' => 'TEXT',
                         'null' => true,
                         'comment' => 'Текст письма который приходит администратору',
                         'comment_en' => '',
                         'newType' => ''
                     )
        );
    ...
    {        
       ...
       {                 
            ...
            foreach($fields as $k=>$f)
            {
                ...
                if(!empty($f['comment_en']))
                {
                    $comment_en[$k] = $f['comment_en']; // Подписи полей
                }
            ...
            $info = array(
                ...
                'comment_en' => serialize($comment_en), // сериализуем подписи (english)
