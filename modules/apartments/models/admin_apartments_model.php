...
class admin_apartments_model extends CI_Model
{
	// конструктор
    ...
    **/
    ...
    {                     
        ...
        {            
            $sql = "
                CREATE TABLE `ci_apartments` (
                	`id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
                	`id_room` VARCHAR(50) NOT NULL DEFAULT '0',
                	`novostroy_id` INT(10) NULL DEFAULT '0',
                	`room_id` INT(10) NULL DEFAULT '0',
                	`name` VARCHAR(255) NULL DEFAULT NULL,
                	`price` INT(10) NULL DEFAULT NULL,
                	`floor` VARCHAR(255) NULL DEFAULT NULL,
                	`square_all` FLOAT NULL DEFAULT NULL,
                	`square_life` VARCHAR(255) NULL DEFAULT NULL,
                	`square_cook` VARCHAR(255) NULL DEFAULT NULL,
                	`sort` INT(3) NULL DEFAULT '100',
                	`main_foto` VARCHAR(255) NULL DEFAULT '/asset/img/logo-M16.png',
                	`banned` INT(1) NULL DEFAULT '0',
                	`shorting` TEXT NULL,
                	`otdelka_id` VARCHAR(20) NULL DEFAULT NULL,
                	PRIMARY KEY (`id`),
