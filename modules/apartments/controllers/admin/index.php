...
/** --------------------------------------------------------------------------------------------- **/
    ...
    **/
    ...
    {    
        ...
        $parent_buildings = $this->admin_buildings_model->parent_id();
        $parent_id_buildings[0] = ' -- не выбрано -- ';
        foreach($parent_buildings as $p)
        {
            $parent_id_buildings[$p['id']] = $p['name'];
        }
        ...
        return array(
                        ...
                        'novostroy_id' => $parent_id_buildings,
