...
document.addEventListener('DOMContentLoaded', function () {
	function showHeaderMenu() { 
	    let headerBurger = document.querySelector('.mobile-burger'); 
	    let headerMenu = document.querySelector('.header-menu__list'); 
	    headerBurger.addEventListener('click', function() {
		    headerBurger.classList.toggle('mobile-burger--active');  
		    headerMenu.classList.toggle('header-menu__list--active'); 
	    });
	};
showHeaderMenu();
});
